<!-- Adcionar Usuário-->
<div class="modal fade" id="addtrat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <form class="user" method="POST" action="{{ route('trat.create') }}">
